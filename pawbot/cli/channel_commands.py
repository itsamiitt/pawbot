"""CLI channel management commands.

Extracted from commands.py Phase 0.
Contains:
  - `channels status` — show channel configuration status
  - `channels login` — link device via QR code (WhatsApp bridge)
"""
...
console = Console()
channels_app = typer.Typer(name="channels", help="Manage channels")
