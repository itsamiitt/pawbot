"""Tests for Phase 16 â€” CLI Commands & Config Schema.
...
class TestCLIFormatter:
    ...
    def test_print_table(self, capsys):
        ...
        # No assertion on exact output â€” just verifying it doesn't crash
...
class TestDoctorCommand:
    ...
    def test_doctor_runs_all_checks(self):
        ...
        runner = CliRunner()
        # Doctor checks may fail due to missing services â€” that's ok.
